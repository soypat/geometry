...
func arcCenterFrom2points(p1, p2 Vec, r float32) (Vec, float32, error) {
	...
	} else if maxChordLen-chordLen < -internal.Smallfloat32 {
		return Vec{}, 0, errBadArc
	} else if math.Abs(chordLen/maxChordLen-1) < internal.Smallfloat32 {
	...
	if math.Abs(diffTo90) < internal.Smallfloat32/10 {
