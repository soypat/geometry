...
func (s Spline3) BasisFunc() (bs func(float32) [4]float32) {
	arr := s.m.Transpose().Array()
	return func(t float32) (b [4]float32) {
		for i := range b {
			off := i * 4
...
func (s Spline3) BasisFuncDiff() (bs func(float32) [4]float32) {
	arr := s.m.Transpose().Array()
	return func(t float32) (b [4]float32) {
		for i := range b {
			off := i * 4
...
func (s Spline3) BasisFuncDiff2() (bs func(float32) [4]float32) {
	arr := s.m.Transpose().Array()
	return func(t float32) (b [4]float32) {
		for i := range b {
			off := i * 4
...
func (s Spline3) BasisFuncDiff3() (bs func(float32) [4]float32) {
	arr := s.m.Transpose().Array()
	return func(t float32) (b [4]float32) {
		for i := range b {
			off := i * 4
