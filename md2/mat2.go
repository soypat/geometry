...
func Diagonal2(a, b float64) Mat2 { return Mat2{x00: a, x11: b} }
...
func EqualMat2(a, b Mat2, tolerance float64) bool {
...
func ScaleMat2(a Mat2, k float64) Mat2 {
	return Mat2{
		x00: k * a.x00,
		x10: k * a.x10,
		x01: k * a.x01,
